...
export function ControlDrawer({ open, onClose, ...controlProps }: ControlDrawerProps) {
  return (
    <>
      ...
      />
      <aside
        className={`fixed inset-x-0 bottom-0 z-50 flex max-h-[min(75vh,32rem)] flex-col rounded-t-2xl border border-b-0 border-[#e8dfd0] bg-[#fffef9] shadow-2xl transition-transform duration-300 ease-out md:hidden ${
