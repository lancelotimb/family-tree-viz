...
import { ChevronLeft, ChevronRight, GitBranch, UserX } from "lucide-react";
...
export function ControlSidebar({
  ...
  return (
    <aside
      className={`pointer-events-auto flex shrink-0 flex-col overflow-hidden rounded-2xl border border-[#e8dfd0] bg-white/75 shadow-lg backdrop-blur-md transition-[width,padding] duration-300 ease-out ${
        collapsed ? "w-12 p-2" : "w-56 gap-5 p-4"
      }`}
    >
