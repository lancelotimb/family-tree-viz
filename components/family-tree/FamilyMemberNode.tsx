...
export function FamilyMemberNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-[#e8dfd0] bg-gradient-to-b from-[#faf6ef] to-[#f0e8da]">
        <User className="h-6 w-6 text-[#a8957a]" strokeWidth={1.5} />
      </div>
      <p className="mt-2 text-center font-serif text-base font-medium leading-tight text-[#3d3428]">
        {member.name}
      </p>
